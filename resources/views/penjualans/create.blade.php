...
@section('h1')
<!-- Title Content -->
    <h1 class="m-0 fw-bold">Tambah Data Penjualan</h1>
@endsection

@section('content')
<title>Cake</title>
<!-- Form Content -->
<form action="/proses-data-penjualan" method="POST" class="row g-5">
    @csrf
    ...
    <div class="col-lg-5 ms-3">
        ...
        <input type="text" name="jumlah_kue" class="form-control" id="jumlah_kue" value="{{ old('jumlah_kue') }}">
    ...
    <div class="col-lg-5 ms-3">
        ...
        <input type="number" name="nominal_harga" class="form-control" id="nominal_harga" value="{{ old('nominal_harga') }}">
